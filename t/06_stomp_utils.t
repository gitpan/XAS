...
my $buffer;
my $transaction = '1234';
my $stomp  = XAS::Lib::Stomp::Utils->new(-target => '1.1');
my $filter = XAS::Lib::Stomp::Parser->new(-target => '1.1');
...
is($frame->header->message_id, $transaction);
...
is($nframe->header->message_id, $transaction);
